							...
							<div class="card__content">
								...
								<form action="#">
									...
									<div class="form-group form-group--sm">
										<a href="_soocer_shop-account.html" class="btn btn-primary-inverse btn-lg btn-block">Sign in to your account</a>
									</div>
								</form>
								<!-- Login Form / End -->
					...
					<div class="col-md-6">
						...
						<div class="card">
							...
							<div class="card__content">
								...
								<!-- Register Form -->
								<form action="{{route('register')}}" type="POST">
                                    @csrf
                                    <div class="form-group">
									...
									<div class="form-group">
										...
										<input type="password" name="password-confirmation" id="password-confirmation" class="form-control" placeholder="Repeat your password...">
									</div>
